...
@Component
public class ValidarCodigoRecuperacionClaveManejador implements ManejadorComandoVariableDeRutaRespuesta<ValidarCodigoRecuperacionClaveComando, String, ComandoRespuesta<Boolean>> {
