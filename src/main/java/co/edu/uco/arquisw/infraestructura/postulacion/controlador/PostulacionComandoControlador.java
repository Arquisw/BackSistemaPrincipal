...
public class PostulacionComandoControlador {
    ...
    public PostulacionComandoControlador(GuardarPostulacionManejador guardarPostulacionManejador, ActualizarPostulacionManejador actualizarPostulacionManejador, SeleccionarUsuarioManejador seleccionarUsuarioManejador) {
    ...
    public ComandoRespuesta<Long> seleccionarUsuario(@PathVariable Long id) {
        return this.seleccionarUsuarioManejador.ejecutar(id);
    }
}